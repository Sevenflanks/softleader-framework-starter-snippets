...
import tw.com.softleader.starter_snippets.demo.entity.DemoAssociation;
...
public class DemoServiceTest {
  ...
  /**
   * passing a wrong idno to some business logic
   */
  @Transactional(propagation = Propagation.NOT_SUPPORTED)
  @Test(expected = ConstraintViolationException.class)
  public void testPassingWrongArg() {
    demoService.doSomeBusinessLogic("A999999999");
  }
